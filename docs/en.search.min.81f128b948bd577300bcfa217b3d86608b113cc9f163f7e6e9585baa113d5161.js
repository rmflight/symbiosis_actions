...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/symbiosis_actions/flexsearch.min.js');loadScript('/symbiosis_actions/en.search-data.min.b43970204a322998cf1c375cf3514503abe3b28624a3bed728e98a40bf78dd32.js',function(){input.required=false;search();});}
