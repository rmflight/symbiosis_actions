...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/symbiosis_actions/flexsearch.min.js');loadScript('/symbiosis_actions/en.search-data.min.bf7f26600dd1d8ee044d1ee07287189a53ce3f6b6a66ed5f87677ae5761510db.js',function(){input.required=false;search();});}
