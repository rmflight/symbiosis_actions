...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/symbiosisnovel/flexsearch.min.js');loadScript('/symbiosisnovel/en.search-data.min.bc9031a4faf8b2843f498561ae670ea7bb84da96d08c3edacccfb2ef93f9120f.js',function(){input.required=false;search();});}
